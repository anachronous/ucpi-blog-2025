# Blog Post for User-Centered Programming Interface Seminar

This is a repository for submitting the final blog post for the UCPI seminar.
...
## Due Date and Submission Logistics
- The final blog post is due on Feb 2, 2026.
- Please submit your blog post as a PR to this repo, and name your file as `[w1-topic].md`, e.g., `w4-visual-debugging.md`.